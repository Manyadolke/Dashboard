  ...
  return (
    <div className='p-9'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
            <SummaryCard icon={<FaUsers/>} text="Total Employees" number={13} color="bg-green-500"/>
        ...
        <div className="mt-12">
             ...
             <SummaryCard icon = {<FaCheckCircle/>} text="Leave Approved " number={2} color="bg-blue-600"/>
